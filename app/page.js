            ...
            <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
                <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
                    <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
                        <span className="font-semibold">Welcome to DevMind!</span> Your ultimate destination <br className="hidden lg:block" /> for tech and coding. (or) <span className="font-semibold underline decoration-primary"><span ref={el} /></span>
                    </h1>
                    <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
                        Explore the latest trends, tutorials, and insights in software development. <br className="hidden lg:block" /> Whether you're an aspiring coder or a seasoned developer, DevMind offers expert advice, guides, and articles to inspire and empower you.
                    </p>
            ...
            <section className="py-12 bg-gray-100 dark:bg-gray-900">
                <div className="container px-4 mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-4xl font-bold text-gray-800 dark:text-gray-200">Becoming a Member</h2>
                    ...
                    <div className="flex flex-wrap justify-center">
                        ...
                        <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                                ...
                                <div className="mt-4">
                                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">What's Typescript?</h3>
                                    <p className="mt-2 text-gray-600 dark:text-gray-400">Typescript is .....</p>
                        ...
                        <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                                ...
                                <div className="mt-4">
                                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">What is Co-operative workflow?</h3>
                                    <p className="mt-2 text-gray-600 dark:text-gray-400">Co-operative workflow means working with the team....</p>
                        ...
                        <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 transform transition duration-500 hover:scale-105">
                                ...
                                <div className="mt-4">
                                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">What is the salary of SDE?</h3>
                                    <p className="mt-2 text-gray-600 dark:text-gray-400"> The current salary as per the survey is....</p>
